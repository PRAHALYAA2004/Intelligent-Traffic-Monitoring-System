class TrafficSimulation {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 2; i++) {
            ...
            cyclistImg.src = `../images/cyclists/cyclist${i}.png`;
        ...
        timeOfDayOptions.forEach(time => {
            ...
            bgImg.src = `../images/backgrounds/${time}-bg.jpg`;
